...
# --- High-End Multi-Tone Header ---
cat << EOF
${BLUE_1}${BOLD}  _      __   _______    _____ _   _  _____ _______       _      _      ______ _____  
${BLUE_2} | |     \ \ / / ____|  |_   _| \ | |/ ____|__   __|/\   | |    | |    |  ____|  __ \ 
${BLUE_3} | |      \ V / |         | | |  \| | (___    | |  /  \  | |    | |    | |__  | |__) |
${CYAN_1} | |       > <| |         | | | .   |\___ \   | | / /\ \ | |    | |    |  __| |  _  / 
${CYAN_2} | |____  / . \ |____    _| |_| |\  |____) |  | |/ ____ \| |____| |____| |____| | \ \ 
${CYAN_2} |______|/_/ \_\_____|  |_____|_| \_|_____/   |_/_/    \_\______|______|______|_|  \_\
${RESET}
EOF
